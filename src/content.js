(function (root, factory) {
  ...
  const LOCATIONS = {
    ...
    bambooForest: { name: '竹林', type: 'wilderness', neighbors: ['village', 'riverbank'], tags: ['wild', 'resource'], interactions: ['forage', 'searchRelic'], population: 'forest' },
    riverbank: { name: '山溪河滩', type: 'wilderness', neighbors: ['bambooForest', 'cliffCave'], tags: ['wild', 'water'], interactions: ['forage', 'searchRelic'], population: 'river' },
    cliffCave: { name: '瀑布石缝', type: 'ruin', neighbors: ['riverbank'], tags: ['hidden', 'relic'], interactions: ['forage', 'searchRelic'], population: 'ruin' },
    ...
    threeForkMountain: { name: '三叉山', type: 'wilderness', neighbors: ['merchantCity', 'heavenClimbMountain'], tags: ['wild', 'inheritance', 'danger'], interactions: ['searchRelic'], population: 'inheritance' },
    heavenClimbMountain: { name: '天梯山', type: 'sacred', neighbors: ['threeForkMountain', 'northernPlains'], tags: ['sacred', 'inheritance', 'danger'], interactions: ['searchRelic'], population: 'heavenClimb' },
    ...
    trueYangTower: { name: '八十八角真阳楼', type: 'ruin', neighbors: ['imperialCourt', 'foxFairyLand'], tags: ['inheritance', 'danger', 'tower'], interactions: ['searchRelic'], population: 'trueYangTower' },
    ...
    shadowSectRuins: { name: '影宗遗址', type: 'ruin', neighbors: ['foxFairyLand', 'centralContinent'], tags: ['shadow', 'ruin', 'secret'], interactions: ['searchRelic'], population: 'shadowSectRuins' },
    ...
    reverseFlowRiver: { name: '逆流河', type: 'wilderness', neighbors: ['northernPlains', 'centralContinent'], tags: ['wild', 'relic', 'survival'], interactions: ['searchRelic'], population: 'reverseFlowRiver' },
    ...
    madDemonCave: { name: '疯魔窟', type: 'ruin', neighbors: ['centralContinent', 'bookMountain', 'dreamRealms'], tags: ['ruin', 'secret', 'danger'], interactions: ['searchRelic'], population: 'madDemonCave' }
  };
