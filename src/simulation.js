(function (root, factory) {
  ...
  function snapshot(state) {
    ...
    return {
      ...
      combat: copy(state.combat || null), rebirth: copy(state.rebirth),
  ...
  const affordanceRuntime = GuAffordances.register({ engine: Engine, locations: LOCATIONS, random, clamp, remember, log, consequence: Consequence.record, damageEntity, advance, copy });
